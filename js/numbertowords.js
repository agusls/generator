...
function forward(n) {
  ...
  if(/[^0-9]/.test(String(n))) return "Please only input numbers in the first box.";
  ...
  // add "ands"
   ...
   answer = answer.replace(/( (?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen))\s?$/g," and$1");
...
//     var lastIndex = answerArray.length-1;
//     if(answerArray[lastIndex-1] !== "and") {
//       answerArray[lastIndex+1] = answerArray[lastIndex];
//       answerArray[lastIndex] = "and";
//       //answerArray[lastIndex-1] = "and";
//     }
//   }
